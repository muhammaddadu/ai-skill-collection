---
name: ads-apple
description: "Apple Ads (Apple Search Ads) analysis for mobile app advertisers: campaign structure, bid health, Custom Product Pages, AdAttributionKit, MMP attribution, TAP coverage, CPA benchmarks. Use when user says Apple Ads, Apple Search Ads, ASA, App Store ads, AdAttributionKit, or an iOS app advertiser."
