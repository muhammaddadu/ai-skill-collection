...
description: "Cross-platform attribution health audit: AdAttributionKit, GA4 attribution models, Consent Mode V2, server-side stitching, MMP health, cross-device. Use when user says attribution audit, AdAttributionKit, AAK, view-through, conversion window, MMP audit, AppsFlyer, Adjust, Branch, or Singular."
