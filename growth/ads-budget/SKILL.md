---
name: ads-budget
description: "Budget allocation and bidding strategy review across ad platforms: spend distribution, bidding fit, scaling readiness, kill/scale calls via the 70/20/10 rule, 3x Kill Rule, and 20% scaling rule. Use when user says budget allocation, bidding strategy, ad spend, ROAS target, or scaling."
